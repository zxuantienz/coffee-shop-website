...
| :--- | :--- | :--- | :--- | :--- |
| **Đoàn Xuân Tiến** |  | Công nghệ thông tin | Quản lý File Báo cáo Word. Thiết kế luồng User Flow (Login, Profile, Order History, Blog). Tìm kiếm tài nguyên. | `doan-xuan-tien` |
| **Xuân Phước** | `[Điền MSSV]` | Công nghệ thông tin | Thiết lập Figma Design System. Code luồng Khám phá (Trang Chủ, Thực đơn, Giới thiệu, Liên hệ). | `xuan-phuoc` |
| **Võ Thanh Danh** | `[Điền MSSV]` | Công nghệ thông tin | Thiết lập Prototype. Code luồng Mua hàng (Chi tiết SP, Giỏ hàng, Checkout, Success). | `thanh-danh` |
